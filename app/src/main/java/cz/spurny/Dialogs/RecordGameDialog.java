...
/**
 * Objekt: RecordGame.java
 * Popis:  Dialog dotazujici se uzivatele zdali chce opravdu zaznamenat danou hru.
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
               ...
               /* Ulozeni preference uzivatele */
                UserPreferences.setRecordDialogShow(context, isChecked);
            }
        });

        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setMessage(context.getString(R.string.RecordGameDialog_string_title))
